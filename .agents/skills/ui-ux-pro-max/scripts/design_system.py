...
def _safe_slug(value: str, fallback: str) -> str:
    """Return a filesystem-safe lowercase slug for persisted names."""
...
def format_page_override_md(design_system: dict, page_name: str, page_query: str = None) -> str:
    ...
    lines.append("")
    lines.append(f"> ⚠️ **IMPORTANT:** Rules in this file **override** the Master file (`design-system/{_safe_slug(project, 'default')}/MASTER.md`).")
