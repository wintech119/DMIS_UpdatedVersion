    ...
    <div class="review-step">
      ...
      <div class="review-metric-grid">
        <mat-card class="review-metric-card">
          ...
          <span class="review-metric-card__meta">{{ formatExecutionStatus(packageDetail()?.package?.execution_status) }}</span>
        </mat-card>
        ...
        <mat-card class="review-metric-card">
          ...
          <strong>{{ packageDetail()?.request?.tracking_no || 'Created on commit' }}</strong>
          <span class="review-metric-card__meta">
            Package {{ packageDetail()?.package?.tracking_no || 'Created on commit' }}
          </span>
        </mat-card>
      </div>
      ...
      <mat-card class="review-section">
        ...
        <div class="reference-grid">
          <div class="reference-card">
            ...
            <strong>{{ packageDetail()?.request?.tracking_no || 'Will be generated on first commit' }}</strong>
          </div>
          <div class="reference-card">
            <span>Package Tracking Number</span>
            <strong>{{ packageDetail()?.package?.tracking_no || 'Will be generated on first commit' }}</strong>
          </div>
          <div class="reference-card">
            <span>Dispatch Document Reference</span>
            <strong>{{ packageDetail()?.allocation?.waybill_no || 'Assigned on dispatch' }}</strong>
          </div>
          <div class="reference-card">
      ...
      <mat-card class="review-section">
        <div class="review-section__header">
          <div>
            ...
            <p>The lines below are the exact reservation candidates that will be saved for this request.</p>
          </div>
        </div>
