...
_ROLE_PERMISSION_COMPAT_OVERRIDES = {
    ...
    "TST_DG": {PERM_EVENT_PHASE_WINDOW_VIEW, PERM_EVENT_PHASE_WINDOW_MANAGE},
    "TST_DIR_PEOD": {PERM_EVENT_PHASE_WINDOW_VIEW, PERM_EVENT_PHASE_WINDOW_MANAGE},
    "DG": {PERM_EVENT_PHASE_WINDOW_VIEW, PERM_EVENT_PHASE_WINDOW_MANAGE},
    "DIRECTOR_GENERAL": {PERM_EVENT_PHASE_WINDOW_VIEW, PERM_EVENT_PHASE_WINDOW_MANAGE},
    "DIR_PEOD": {PERM_EVENT_PHASE_WINDOW_VIEW, PERM_EVENT_PHASE_WINDOW_MANAGE},
    "ODPEM_DG": {PERM_EVENT_PHASE_WINDOW_VIEW, PERM_EVENT_PHASE_WINDOW_MANAGE},
    "ODPEM_DIR_PEOD": {PERM_EVENT_PHASE_WINDOW_VIEW, PERM_EVENT_PHASE_WINDOW_MANAGE},
}
