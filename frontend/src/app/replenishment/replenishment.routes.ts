...
export const REPLENISHMENT_ROUTES: Routes = [
  ...
  { path: 'needs-list/:id/transfers', component: TransferDraftsComponent },
  { path: 'needs-list/:id/donations', component: DonationAllocationComponent },
  { path: 'needs-list/:id/procurement', component: ProcurementListComponent },
  { path: 'procurement/new', redirectTo: 'needs-list-review', pathMatch: 'full' },
  { path: 'procurement/:procId', component: ProcurementDetailComponent },
  { path: 'procurement/:procId/edit', component: ProcurementFormComponent },
  { path: 'procurement/:procId/receive', component: ProcurementIntakeComponent },
];
