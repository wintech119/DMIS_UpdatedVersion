...
class IFRCSuggestionCandidateSerializer(serializers.Serializer):
    ...
    size_weight = serializers.CharField(max_length=40, allow_blank=True, required=False)
    form = serializers.CharField(max_length=40, allow_blank=True, required=False)
    material = serializers.CharField(max_length=40, allow_blank=True, required=False)
