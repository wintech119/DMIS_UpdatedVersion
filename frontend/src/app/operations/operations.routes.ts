...
export const OPERATIONS_ROUTES: Routes = [
  ...
  { path: 'relief-requests/new', component: ReliefRequestWizardComponent, canActivate: [appAccessGuard], data: { accessKey: 'operations.relief-requests' } },
  ...
  { path: 'relief-requests/:reliefrqstId/edit', component: ReliefRequestWizardComponent, canActivate: [appAccessGuard], data: { accessKey: 'operations.relief-requests' } },
