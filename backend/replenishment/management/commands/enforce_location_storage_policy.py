...
_SQL_TEMPLATE_NAME = "20260324_location_storage_policy.sql"


class Command(BaseCommand):
    help = (
        "Render and optionally apply the location-storage policy SQL "
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("Applied location storage policy SQL."))
