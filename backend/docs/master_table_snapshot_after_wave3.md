...
- Generated at (UTC): `2026-03-03T22:29:09.577366+00:00`
...
| `allocation_priority_rule` | `True` | `0` |
| `allocation_rule` | `True` | `0` |
| `approval_authority_matrix` | `True` | `0` |
| `approval_reason_code` | `True` | `5` |
...
| `resource_capability_ref` | `True` | `4` |
| `role` | `True` | `15` |
| `role_scope_policy` | `True` | `0` |
| `supplier` | `True` | `4` |
| `tenant` | `True` | `28` |
| `tenant_access_policy` | `True` | `0` |
