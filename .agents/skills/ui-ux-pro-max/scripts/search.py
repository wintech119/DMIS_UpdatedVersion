...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Create page-specific override file in design-system/<project-slug>/pages/*.md",
    )
    parser.add_argument(
        "--output-dir",
        "-o",
    ...
    if args.design_system:
        ...
        if invalid_mode_flags:
            parser.error("--design-system cannot be combined with " + ", ".join(invalid_mode_flags) + ".")
    else:
        ...
        if invalid_design_system_flags:
            parser.error(", ".join(invalid_design_system_flags) + " require --design-system.")
    ...
    if args.design_system:
        ...
        if args.persist:
            if not isinstance(result, dict):
                parser.error("--persist expected persisted design-system metadata.")
            ...
            print("\n" + "=" * 60)
            print(f"Saved design system to {display_dir}/")
