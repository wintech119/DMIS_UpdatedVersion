...
PERM_OPERATIONS_REQUEST_CANCEL = "operations.request.cancel"
...
PERM_MASTERDATA_TENANT_TYPE_MANAGE = "masterdata.tenant_type.manage"
...
for executive_role_code in (
    ...
    _DEV_ROLE_PERMISSION_MAP[executive_role_code] = set(_DEV_ROLE_PERMISSION_MAP["EXECUTIVE"])
...
_ROLE_PERMISSION_COMPAT_OVERRIDES = {
    ...
    "ODPEM_DDG": _DEV_ROLE_PERMISSION_MAP["EXECUTIVE"]
    | {
...
def _compat_operations_permissions_for_permissions(permissions: Iterable[str]) -> set[str]:
    ...
    if PERM_NEEDS_LIST_APPROVE.lower() in normalized:
        compat.add(PERM_OPERATIONS_PARTIAL_RELEASE_APPROVE)
