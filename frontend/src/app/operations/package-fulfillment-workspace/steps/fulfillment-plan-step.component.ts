...
import { AllocationCandidate } from '../../models/operations.model';
        ...
        <mat-card class="execution-item-card">
          <div class="execution-item-card__header">
            <div class="execution-item-card__identity">
              <span class="execution-item-card__eyebrow">Item {{ item.item_id }}</span>
          ...
          <div class="execution-metric-grid">
            <div class="execution-metric">
              <span class="execution-metric__label">Requested</span>
              <span class="execution-metric__value">{{ item.request_qty | number:'1.0-4' }}</span>
            </div>
            <div class="execution-metric">
              <span class="execution-metric__label">Issued</span>
              <span class="execution-metric__value">{{ item.issue_qty | number:'1.0-4' }}</span>
            </div>
            <div class="execution-metric">
              <span class="execution-metric__label">Remaining</span>
          ...
          <div class="execution-guidance">
            ...
            <div class="execution-guidance__actions">
              <button
                mat-stroked-button
                type="button"
                [disabled]="readOnly"
                  ...
                  <tr [class.execution-row--selected]="store.getSelectedQtyForCandidate(item.item_id, candidate) > 0">
                    ...
                    <td>
                      <input
                        ...
                        [attr.aria-label]="'Quantity to reserve for batch ' + (candidate.batch_no || candidate.batch_id)"
                      />
                    </td>
                  </tr>
                }
