...
The DMIS architecture-review gate is mandatory by `frontend/AGENTS.md:24` and `backend/AGENTS.md:31` for low-medium and higher risk work. This file is duplicated across all six analysis/implementation/review skills and kept in lockstep by the pre-commit drift hook.
