...
import { InventoryRepackagingComponent } from './replenishment/inventory-repackaging/inventory-repackaging.component';
...
export const routes: Routes = [
  ...
  { path: 'replenishment/inventory/repackaging', component: InventoryRepackagingComponent },
  { path: 'replenishment/inventory/repackaging/:repackagingId', component: InventoryRepackagingComponent },
  // Procurement routes
