...
| AC05 Triggers booleans included (activate_B/activate_C/activate_all) | Partial | `backend/replenishment/services/needs_list.py` (`build_preview_items`) | Best-effort logic pending doc confirmation. |
