...
class Command(BaseCommand):
    help = (
        "Seed temporary parish-to-subordinate request-authority data for Relief Management QA. "
        "Dry-run by default."
    )
    ...
    def handle(self, *args: Any, **options: Any) -> None:
        ...
        self.stdout.write("Relief Management hierarchy test-data seed:")
        self.stdout.write(f"- parish tenant: {parish['tenant_id']} ({parish['tenant_code']}) {parish['tenant_name']}")
        self.stdout.write(
            f"- subordinate tenant: {subordinate['tenant_id']} ({subordinate['tenant_code']}) {subordinate['tenant_name']}"
        )
        ...
        with transaction.atomic():
            ...
            TenantRequestPolicy.objects.update_or_create(
                ...
                defaults={
                    ...
                    "request_authority_tenant_id": parish["tenant_id"],
            ...
            TenantControlScope.objects.update_or_create(
