...
@Component({
  ...
  template: `
    <div class="skeleton-container" aria-label="Loading content" role="status" aria-live="polite">
      @for (_ of countArray; track _) {
        @switch (variant) {
          <!-- Stat box: 80px rounded box -->
          @case ('stat-box') {
            <div class="skeleton skeleton-stat-box" aria-hidden="true">
          ...
          @case ('warehouse-card') {
            <div class="skeleton skeleton-warehouse-card" aria-hidden="true">
          ...
          @case ('table-row') {
            <div class="skeleton skeleton-table-row" aria-hidden="true">
          ...
          @case ('form-field') {
            <div class="skeleton skeleton-form-field" aria-hidden="true">
          ...
          @case ('summary-card') {
            <div class="skeleton skeleton-summary-card" aria-hidden="true">
              <div class="shimmer line-header"></div>
              <div class="shimmer line-wide"></div>
              <div class="shimmer line-medium"></div>
            </div>
          ...
          @case ('text-line') {
            <div class="skeleton skeleton-text-line" aria-hidden="true">
              <div class="shimmer line-wide"></div>
            </div>
          }
        }
